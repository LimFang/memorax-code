...
import { createBackendState } from "./backend-state.js";
import { createBackendServer, type BackendServer } from "./server.js";
import { backendDebug } from "./debug-log.js";
import { prepareClientPluginRemovalCleanup } from "./client-plugin-removal.js";
import {
  resolveBackendInstallWatchdogConfig,
  startBackendInstallWatchdog,
} from "./install-watchdog.js";
import { activateCodexPlugin, installCodexPlugin } from "./codex-plugin-install.js";
import { inspectCodexPluginHooks, trustCodexPluginHooks, type CodexHook } from "./codex-plugin-hooks.js";
import {
...
} from "./memorax-code-lifecycle.js";
import { backendEnv } from "./backend-env.js";
import {
  backendServiceHome,
  BackendLifecycleLockError,
  withBackendLifecycleLock,
} from "./backend-lifecycle-lock.js";
import {
  startBackendShutdownRequestWatcher,
  type BackendShutdownRequestWatcher,
} from "./backend-shutdown-request.js";
import { runtimeRecordDurabilityWarning } from "./backend-service-result.js";
