...
import { seedMissingMemoraxCodeConfig } from "./memorax-config.js";
import { runProcessWithWindowsNpm } from "./windows-cli-invocation.js";
import { loadManagedClientsConfig, resolveManagedClients, type ManagedClients } from "./client-selection.js";
import { clearActiveManagedClients, readActiveManagedClients, writeActiveManagedClients } from "./active-client-selection.js";
import { codexAdapterLifecycle } from "./codex-adapter-lifecycle.js";
import { claudeAdapterLifecycle } from "./claude-adapter-lifecycle.js";
import type {
  AdapterReport,
} from "./adapter-lifecycle-participant.js";
export type {
