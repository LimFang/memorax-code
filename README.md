...
| **Background Repo Memory maintenance** | Starts an initial background build when the Backend-authorized Git worktree has no `.repo_memory/PROFILE.md`, then updates existing Repo Memory according to policy. |
